...
# %% #Checking the missing values  (à mettre au propre à la fin, juste explorer missing)
...
listing_missing_values = listing_data[listing_review_columns].isnull().sum()
print(listing_missing_values)
...
plt.show()
#NOTE : Data is not linked to new or inexperienced host
...
# %% LICENSE
listing_data["license"] = listing_data["license"].notnull()
print(listing_data["license"].value_counts())
...
#Lots of availability 0 -- probably inactive -- imput false has availability
...
# %% Tranforming the dataframe inactive into a csv
